...
SEED_TASKS = [
    {
            "title": "Осторожно: игровые мошенники!",
            "description": "Узнай, как не попасться на уловки в играх и соцсетях",
            "instructions": "Листай карточки, запоминай признаки мошенничества и нажимай «Запомнил!»",
            "topic": "gaming_scams",
                ...
                "cards": [
                    {
                        "id": "g1",
                        "emoji": "🤑",
                        "title": "«Бесплатные робуксы!» — это обман",
                        "type": "danger",
                        "text": "🎯 Как это выглядит:\n• Реклама: «Получи 1000 робуксов бесплатно!»\n• Ссылка: «Перейди и введи пароль»\n• Сообщение от «администратора»\n\n⚠️ Почему это опасно:\n• Взламывают аккаунт\n• Крадут личные данные\n• Могут украсть скины и игровую валюту",
                        "color": "#FF6B6B"
                    },
                    {
                        "id": "g2",
                        "emoji": "🔐",
                        "title": "Никогда не давай пароль!",
                        "type": "warning",
                        "text": "🎯 Кто просит пароль:\n• «Администратор» игры\n• «Разработчик»\n• «Друг», которому срочно нужна помощь\n\n🔒 Золотое правило:\nНАСТОЯЩИЙ администратор НИКОГДА не попросит пароль!\n\n✅ Если кто-то просит пароль — это мошенник. Сразу сообщи взрослым!",
                        "color": "#F59E0B"
                    },
                    {
                        "id": "g3",
                        "emoji": "💎",
                        "title": "Бесплатные скины и донаты",
                        "type": "danger",
                        "text": "🎯 Как выглядят такие предложения:\n• «Нажми на ссылку и получи скин»\n• «Проголосуй и получи донат»\n• «Подпишись на канал и выиграй»\n\n⚠️ Что на самом деле:\n• Ссылка ведёт на сайт-подделку\n• Просят ввести логин и пароль\n• После этого аккаунт взламывают\n\n✅ Запомни: НИКАКИХ бесплатных скинов не бывает!",
                        "color": "#FF6B6B"
                    },
                    {
                        "id": "g4",
                        ...
                        "type": "success",
                        "text": "✅ Правила безопасности:\n\n1️⃣ Не верь в бесплатные подарки от незнакомцев\n2️⃣ Никогда не вводи пароль на незнакомых сайтах\n3️⃣ Всегда спрашивай у родителей\n4️⃣ Сообщай о подозрительных сообщениях\n\n🎯 Запомни: настоящие розыгрыши проводят только официальные аккаунты!",
                        "color": "#22C55E"
                    }
                ]
            }
        ...
        {
            "title": "Найди мошенника в чате",
            "description": "Определи, кто из игроков пытается тебя обмануть",
            "instructions": "Кликни на сообщение, которое написал мошенник. Будь внимателен!",
            "topic": "gaming_scams",
            "task_type": "scam_chat",
            "age_groups": ["middle", "senior"],
            "points": 15,
            ...
            "content": {
                "messages": [
                    {"id": "m1", "user": "КрутойИгрок", "avatar": "🟢", "text": "Привет! Хочешь бесплатные робуксы? Напиши мне свой пароль!", "isScam": True},
                    {"id": "m2", "user": "Дружбан", "avatar": "🟢", "text": "Сыграем в королевскую битву вместе? Я жду тебя!", "isScam": False},
                    {"id": "m3", "user": "Хакер228", "avatar": "🔴", "text": "Перейди по ссылке и получи 5000 V-баксов! Только сегодня!", "isScam": True},
                    {"id": "m4", "user": "Новичок", "avatar": "🟢", "text": "Я тут новичок, можешь научить играть?", "isScam": False},
                ]
            }
        },
        {
            "title": "Где украли аккаунт?",
            "description": "Найди момент, когда мошенники украли аккаунт",
            "instructions": "Нажми на шаг, где произошла кража аккаунта.",
            "topic": "gaming_scams",
            ...
            "content": {
                "steps": [
                    {"id": "s1", "emoji": "📱", "text": "Ты увидел рекламу бесплатных робуксов"},
                    {"id": "s2", "emoji": "👆", "text": "Ты нажал на ссылку"},
                    {"id": "s3", "emoji": "📝", "text": "Ты ввел логин и пароль на поддельном сайте"},
                    {"id": "s4", "emoji": "💀", "text": "Мошенники получили твой пароль и украли аккаунт"}
                ]
            }
        },
        {
            "title": "Поддельное письмо",
            "description": "Найди все признаки мошенничества в письме",
            "instructions": "Кликни на все признаки мошенничества в письме.",
            "topic": "gaming_scams",
            ...
            "content": {
                "signs": [
                    {"id": "p1", "text": "📨 Адрес отправителя: support@robux-free.com", "isSuspicious": True},
                    {"id": "p2", "text": "🎁 Обещают бесплатные робуксы", "isSuspicious": True},
                    {"id": "p3", "text": "⏰ Акция действует всего 5 минут", "isSuspicious": True},
                    {"id": "p4", "text": "🔗 Просят ввести логин и пароль", "isSuspicious": True},
                    {"id": "p5", "text": "✍️ Есть орфографические ошибки", "isSuspicious": True},
                ]
            }
        },
        {
            "title": "Как защитить себя?",
            "description": "Проверь, сможешь ли ты защитить свой аккаунт от мошенников",
            "instructions": "В каждой ситуации выбери правильное действие. Только верные решения спасут твой аккаунт!",
            "topic": "gaming_scams",
            ...
            "content": {
                "steps": [
                    {"id": "d1", "title": "⚠️ Подозрительный вход", "description": "Ты получил уведомление: Кто-то пытается войти в твой аккаунт из другого города. Твои действия?", "correct": 1},
                    {"id": "d2", "title": "📧 Подозрительное письмо", "description": "Ты получил письмо с просьбой ввести пароль для подтверждения аккаунта. Что делать?", "correct": 1},
                    {"id": "d3", "title": "🔐 Двухфакторная аутентификация", "description": "Ты включил двухфакторную аутентификацию. Это значит, что при входе нужен код из SMS. Это правильно?", "correct": 0}
                ],
                "options": [
                    ["Ввести пароль", "Заблокировать вход и сменить пароль", "Ничего не делать"],
                    ["Ввести пароль", "Проигнорировать письмо", "Сообщить в поддержку игры"],
                    ["Да", "Нет"]
                ]
            }
        },
